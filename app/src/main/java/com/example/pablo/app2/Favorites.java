...
public class Favorites extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ListView listView = (ListView)v.findViewById(R.id.listViewFavorites);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            List<FavoriteDB> messages = Select.from(FavoriteDB.class).orderBy("-id").list();


            for (FavoriteDB element : messages) {
